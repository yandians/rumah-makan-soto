...
import PrintLaporanPendapatan from "./PrintLaporanPendapatan";

export default function IndexLaporanPendapatan({
    auth,
    kasMasuk,
    ...
    const handleReset = () => {
        ...
        Inertia.get(route("kasLaporanPendapatan.index"));
    };
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.get(route("kasLaporanPendapatan.index"), filterParams);
    };
