...
import PrintLaporanBukuBesar from "./PrintLaporanBukuBesar";
registerLocale("id", id);
setDefaultLocale("id");

import logo from "../../../Assets/Logo Full Rumah Makan Soto.png";

export default function IndexLaporanBukuBesar({
    auth,
    kas,
    ...
    const handleReset = () => {
        ...
        Inertia.get(route("kasLaporanBukuBesar.index"));
    };
    ...
    const handleSubmit = (e) => {
        ...
        Inertia.get(route("kasLaporanBukuBesar.index"), filterParams);
    };
